"""
Ablates given parameter, run from command line 
"""
...
if __name__ == '__main__':
    ...
    model_arg, dataset_arg, tune_min, tune_max, tune_step = sys.argv[1:]
    ...
    settings_dict = {
        ...
        "optimizers": ['KinFwd'],
        "tune_param": 'g',
        "tune_range": list(np.arange(float(tune_min), float(tune_max), float(tune_step)))
    }
